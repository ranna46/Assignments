...
summary(movies)
str(movies)
barplot(sapply(movies[,6:15],sum),col=1:10)

###############1##############
# Applying apriori algorithm to get relevant rules
rules <- apriori(as.matrix(movies[,6:15]),parameter = list(support=0.004,confidence=0.06,minlen=5))
inspect(rules)
...
###############2##############
# Applying apriori algorithm to get relevant rules
rules1 <- apriori(as.matrix(movies[,6:15]),parameter = list(support=0.002,confidence=0.05,minlen=4))
inspect(rules1)
...
###############3##############
# Applying apriori algorithm to get relevant rules
rules2 <- apriori(as.matrix(movies[,6:15]),parameter = list(support=0.003,confidence=0.05,minlen=5))
inspect(rules2)
...
###############4##############
# Applying apriori algorithm to get relevant rules
rules3 <- apriori(as.matrix(movies[,6:15]),parameter = list(support=0.005,confidence=0.06,minlen=4))
inspect(rules3)
...
###############5##############
# Applying apriori algorithm to get relevant rules
rules4 <- apriori(as.matrix(movies[,6:15]),parameter = list(support=0.006,confidence=0.06,minlen=5))
inspect(rules4)
