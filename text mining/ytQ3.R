#getting youtube comment data for movie 'escape room'
...
client_id <- "695328294071-phcbimsdebqed65gudschoubv1vhif0i.apps.googleusercontent.com"
client_secret <- "ocia2tkqHBzgaa7tUNOSRfqF"

# use the youtube oauth 
yt_oauth(app_id = client_id,
         app_secret = client_secret,
         token = 'AIzaSyDFbFq8q41xzEAS5fDZKpazbRMMHranZnk')

#extracting comments
comments <- get_all_comments(video_id = '6dSKUoV0SNI')
data <- comments$textOriginal
View(data)
write.table(data, file = "escaperoom.txt")
getwd()
...
#It seems that close to 60-70% of people like the movie. 
